...
<html lang="en">
	...
	<?php include 'header.php'?>
		...
		<!-- /Hero-area -->
				...
				<!-- courses -->
				<hr class="section-hr" id="biology">
				<div id="courses-wrapper" >
                 		
					<!-- row -->
					<div class="row" >
                        <div class="section-header text-center" >
							<h2>Courses Available For Biological Science in Sri Lanka</h2>
						</div>
						   
						<!-- single course -->
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								<a href="mbbs.php" target="_blank" class="course-img">
									<img src="./img/mbbs.png" alt="M.B.B.S">
									<i class="course-link-icon fa fa-link"></i>
								</a>
								<a class="course-title" href="mbbs.php" target="_blank" style="font-size:18px; text-align: center">Bachelor of Medicine and Bachelor of Surgery</a>
								<div class="course-details" style="margin:5px;">
									<span class="course-category">M.B.B.S</span>
								</div>
							</div>
						</div>
						<!-- /single course -->
